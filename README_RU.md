...
### Как навык Hermes Agent

```bash
# Скопируйте в директорию навыков Hermes
...
### Как самостоятельный справочник
...
Данный фреймворк вдохновлён операционной структурой ведущих квантовых торговых фирм. Персонажи ролей являются **вымышленными представлениями** институциональной экспертизы — они не связаны с какой-либо упомянутой фирмой, не одобрены ею и не аффилированы с ней. Цель — передать *методологическую строгость* и *предметную специализацию*, которые делают эти фирмы успешными, и сделать это доступным через LLM-агентов.

Отдельная благодарность:
- [TradingAgents](https://github.com/TauricResearch/TradingAgents) от Tauric Research — за пионерскую работу над парадигмой мультиагентных фреймворков финансового трейдинга
- [Claude Code](https://github.com/anthropics/claude-code) от Anthropic — за среду исполнения агентов
- [Hermes Agent](https://hermes.nousresearch.com) от Nous Research — за фреймворк навыков и возможности оркестрации
